import os
from tf_model import Model_Voting as Model
from tf_trainer_voting import Trainer
    ...
    for random_seed in [2019]:
        ...
        model = Model(init="xavier", user_max_id=src_dataset.feat_sizes[0],
                                       ...
                                       batch_norm=batch_norm, layer_norm=layer_norm,
                                        ...
                                        subnet_N=subnet_N, cotrain=cotrain, orth=orth, orth_alpha=orth_alpha,
                                        voting=voting, matrix_reg=matrix_reg, anchor_user=anchor_user,
                                        anchor_user_num=anchor_user_num, anchor_user_orth=anchor_user_orth,
                                        anchor_user_orth_alpha=anchor_user_orth_alpha)
