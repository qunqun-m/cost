import os
from tf_model import Model_Sharespecific as Model
from tf_trainer_sharespecific import Trainer
...
def train():
    ...
    for random_seed in [2019]:
        ...
        model = Model(init="xavier", user_max_id=src_dataset.feat_sizes[0],
                                       ...
                                       cotrain=cotrain, input_num_share=input_num_share, anchor_input=anchor_input,
                                       input_num_specific=input_num_specific, input_head_num=input_head_num,
                                       anchor_net=anchor_net, net_num_share=net_num_share,
                                       net_num_specific=net_num_specific, net_head_num=net_head_num, l2=l2)
