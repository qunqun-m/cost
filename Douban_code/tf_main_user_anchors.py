...
from tf_trainer_user_anchors import Trainer
...
def train():
    ...
    for random_seed in [2019]:
        ...
        model = Model(init="xavier", user_max_id=src_dataset.feat_sizes[0],
                                    ...
                                    l2=l2, anchor_user_orth=anchor_user_orth,
                                    anchor_user_orth_alpha=anchor_user_orth_alpha, anchor_score_reg=anchor_score_reg,
                                    head_num=head_num, k_ratio=k_ratio, k_ratio2=k_ratio2, tau=tau)
