...
class Trainer:
    ...
    def _predict_ctr(self, user_ids, user_historys, neg_items, part):
        ...
        feed_dict = {self.model.user_id: user_ids,
                     self.model.item_id: neg_items,
                     self.model.is_src: is_src}
    ...
    def fit(self):
        ...
        while epoch <= self.n_epoch:
            ...
            for batch_data in self.train_gen1:
                ...
                batch_loss1, batch_pred1 = self._train(user_id1, item_id1, user_history1, y1, 'src')
                # source
                ...
                try:
                    ...
                    batch_loss2, batch_pred2 = self._train(user_id2, item_id2, user_history2, y2, 'trg')
